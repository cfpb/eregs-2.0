...
# this migration manually runs the raw SQL to create the indices because the functions
# that do it pythonically are not available until Django 1.11 and we're still on
# Django 1.8
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        --
        CREATE INDEX `eregs_core__version_idx` ON `eregs_core_version` (`version`, `left_version`, `right_version`);
        --
